...
@Injectable()
export class ProductIndicationService {

	private productUrl = environment.server_url + 'product-indication';
	private imgUrl = environment.server_url + 'product-indication-img';

	constructor(private utils: ServiceUtils) { }

	findAll(page = 1, filters?: ProductIndicationFilters, total?: number) {
